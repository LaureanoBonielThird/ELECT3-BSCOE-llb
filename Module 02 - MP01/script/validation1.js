function validate(){
    ...
    if(document.myForm.address.value =="") {
        document.getElementById("addressErr").innerHTML="Please enter your Complete Address";
    ...
    if(document.myForm.yearlevel.value == "-1"){
        document.getElementById("yearlevelErr").innerHTML="Please choose your Year Level";
        return false;
    }

    if(document.myForm.section.value == "") {
        document.getElementById("sectionErr").innerHTML="Please enter your Section";
